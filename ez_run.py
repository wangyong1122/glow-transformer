...
from learner_glow import train_glow
...
from models.transformer_vae import AutoTransformer2
...
parser.add_argument('--model',  type=str, default='Transformer', choices=['Transformer', 'TransformerIns', 'TransformerIww', 'AutoTransformer', 'AutoTransformer2', 'AutoTransformer3'])
...
# parser.add_argument('--lr_glow', type=float, default=1e-3)
# parser.add_argument('--sample_bs', type=int, default=10)
# parser.add_argument('--sample_t', type=int, default=1)
parser.add_argument('--glow_mode', action='store_true')
...
# parser.add_argument('--save_dir', type=str, default='./glow/', help='directory for log / saving')
# parser.add_argument('--load_dir', type=str, default='./glow/', help='directory from which to load existing model')
...
hp_str = (  f".{args.dataset}_{args.params}_"
            ...
            f"{'glow_mode_' if args.glow_mode else ''}"
...
# elif args.model=='AutoTransformer2':
...
if args.mode == 'train':
    ...
    # else:
    if args.glow_mode:
        train_glow(args, watcher, model, dataloader.train, dataloader.dev, decoding_path=decoding_path)
    else:
